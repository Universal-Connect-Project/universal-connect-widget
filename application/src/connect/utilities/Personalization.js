import { setLocale, loadJSON, getLocale } from 'src/connect/utilities/Intl'

// gettext related base language files
import frCa from 'src/connect/const/language/frCa.json'
import enCa from 'src/connect/const/language/enCa.json'
// This is a catch-all for spanish. Country code optional.
import es from 'src/connect/const/language/es.json'
...
import exampleEnUs from 'src/connect/const/language/custom_copy/example_custom_copy-en-us.json'
import regionsEnUs from 'src/connect/const/language/custom_copy/regions_custom_copy-en-us.json'
import mandtEnUs from 'src/connect/const/language/custom_copy/mandt_custom_copy-en-us.json'
import nohoEnUs from 'src/connect/const/language/custom_copy/noho_custom_copy-en-us.json'
